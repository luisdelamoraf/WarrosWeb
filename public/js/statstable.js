...
console.log("FINAL", arrayPartido);

// Creación de arrayQ1
Q1_twoM=0, Q1_fgA=0, Q1_thrM=0, Q1_thrA=0, Q1_ftM=0, Q1_ftA=0, Q1_rDf=0, Q1_rOf=0, Q1_As=0, Q1_St=0, Q1_Bl=0, Q1_TO=0, Q1_Fo=0
matchData.collection("jugadores").get().then(function(querySnapshot) {
    querySnapshot.forEach(function(doc) {
        matchData.get().then(function(equipo){
            firestore.doc(`equipos/${equipo.data().Equipo}/jugadores/${doc.id}`).get().then(function(jugador){
                Q1_twoM+=doc.data().Q1.twoM
                Q1_fgA+=doc.data().Q1.twoA
                ...
                jugadorJSON = {
                    ...
                    fgA:(doc.data().Q1.twoM + doc.data().Q1.thrA),
                    fgP:((doc.data().Q1.twoM + doc.data().Q1.thrM)/(doc.data().Q1.twoM + doc.data().Q1.thrA)*100).toFixed(1),
                ...
                totalQ1= {
                    ...
                    fgM: (Q1_twoM + Q1_thrM),
                    fgA: (Q1_fgA + Q1_fgA),
                    fgP: ((Q1_twoM + Q1_thrM)/( Q1_fgA + Q1_thrA)*100).toFixed(1),
                    thrM: Q1_thrM,
                    thrA: Q1_thrA,
...
console.log("Q1", arrayQ1);

// Creación de arrayQ2
Q2_twoM=0, Q2_fgA=0, Q2_thrM=0, Q2_thrA=0, Q2_ftM=0, Q2_ftA=0, Q2_rDf=0, Q2_rOf=0, Q2_As=0, Q2_St=0, Q2_Bl=0, Q2_TO=0, Q2_Fo=0
matchData.collection("jugadores").get().then(function(querySnapshot) {
    querySnapshot.forEach(function(doc) {
        matchData.get().then(function(equipo){
            firestore.doc(`equipos/${equipo.data().Equipo}/jugadores/${doc.id}`).get().then(function(jugador){
                Q2_twoM+=doc.data().Q2.twoM
                Q2_fgA+=doc.data().Q2.twoA
                ...
                jugadorJSON = {
                    ...
                    fgA:(doc.data().Q2.twoM + doc.data().Q2.thrA),
                    fgP:((doc.data().Q2.twoM + doc.data().Q2.thrM)/(doc.data().Q2.twoM + doc.data().Q2.thrA)*100).toFixed(1),
                ...
                totalQ2= {
                    ...
                    fgM: (Q2_twoM + Q2_thrM),
                    fgA: (Q2_fgA + Q2_fgA),
                    fgP: ((Q2_twoM + Q2_thrM)/( Q2_fgA + Q2_thrA)*100).toFixed(1),
                    thrM: Q2_thrM,
                    thrA: Q2_thrA,
...
console.log("Q2", arrayQ2);

// Creación de arrayQ3
Q3_twoM=0, Q3_fgA=0, Q3_thrM=0, Q3_thrA=0, Q3_ftM=0, Q3_ftA=0, Q3_rDf=0, Q3_rOf=0, Q3_As=0, Q3_St=0, Q3_Bl=0, Q3_TO=0, Q3_Fo=0
matchData.collection("jugadores").get().then(function(querySnapshot) {
    querySnapshot.forEach(function(doc) {
        matchData.get().then(function(equipo){
            firestore.doc(`equipos/${equipo.data().Equipo}/jugadores/${doc.id}`).get().then(function(jugador){
                Q3_twoM+=doc.data().Q3.twoM
                Q3_fgA+=doc.data().Q3.twoA
                ...
                jugadorJSON = {
                    ...
                    fgA:(doc.data().Q3.twoM + doc.data().Q3.thrA),
                    fgP:((doc.data().Q3.twoM + doc.data().Q3.thrM)/(doc.data().Q3.twoM + doc.data().Q3.thrA)*100).toFixed(1),
                ...
                totalQ3= {
                    ...
                    fgM: (Q3_twoM + Q3_thrM),
                    fgA: (Q3_fgA + Q3_fgA),
                    fgP: ((Q3_twoM + Q3_thrM)/( Q3_fgA + Q3_thrA)*100).toFixed(1),
                    thrM: Q3_thrM,
                    thrA: Q3_thrA,
...
console.log("Q3", arrayQ3);

// Creación de arrayQ4
Q4_twoM=0, Q4_fgA=0, Q4_thrM=0, Q4_thrA=0, Q4_ftM=0, Q4_ftA=0, Q4_rDf=0, Q4_rOf=0, Q4_As=0, Q4_St=0, Q4_Bl=0, Q4_TO=0, Q4_Fo=0
matchData.collection("jugadores").get().then(function(querySnapshot) {
    querySnapshot.forEach(function(doc) {
        matchData.get().then(function(equipo){
            firestore.doc(`equipos/${equipo.data().Equipo}/jugadores/${doc.id}`).get().then(function(jugador){
                Q4_twoM+=doc.data().Q4.twoM
                Q4_fgA+=doc.data().Q4.twoA
                ...
                jugadorJSON = {
                    ...
                    fgA:(doc.data().Q4.twoM + doc.data().Q4.thrA),
                    fgP:((doc.data().Q4.twoM + doc.data().Q4.thrM)/(doc.data().Q4.twoM + doc.data().Q4.thrA)*100).toFixed(1),
                ...
                totalQ4= {
                    ...
                    fgM: (Q4_twoM + Q4_thrM),
                    fgA: (Q4_fgA + Q4_fgA),
                    fgP: ((Q4_twoM + Q4_thrM)/( Q4_fgA + Q4_thrA)*100).toFixed(1),
                    thrM: Q4_thrM,
                    thrA: Q4_thrA,
...
console.log("Q4", arrayQ4);

// Creación de arrayOT
OT_twoM=0, OT_fgA=0, OT_thrM=0, OT_thrA=0, OT_ftM=0, OT_ftA=0, OT_rDf=0, OT_rOf=0, OT_As=0, OT_St=0, OT_Bl=0, OT_TO=0, OT_Fo=0
matchData.collection("jugadores").get().then(function(querySnapshot) {
    querySnapshot.forEach(function(doc) {
        matchData.get().then(function(equipo){
            firestore.doc(`equipos/${equipo.data().Equipo}/jugadores/${doc.id}`).get().then(function(jugador){
                OT_twoM+=doc.data().OT.twoM
                OT_fgA+=doc.data().OT.twoA
                ...
                jugadorJSON = {
                    ...
                    fgA:(doc.data().OT.twoM + doc.data().OT.thrA),
                    fgP:((doc.data().OT.twoM + doc.data().OT.thrM)/(doc.data().OT.twoM + doc.data().OT.thrA)*100).toFixed(1),
                ...
                totalOT= {
                    ...
                    fgM: (OT_twoM + OT_thrM),
                    fgA: (OT_fgA + OT_fgA),
                    fgP: ((OT_twoM + OT_thrM)/( OT_fgA + OT_thrA)*100).toFixed(1),
                    thrM: OT_thrM,
                    thrA: OT_thrA,
...
function displayTable(array, total){
    // specify the columns
    var columnDefs = [
        {headerName: "No.", field: "numero", width: 80, sortable: true,  pinned: 'left', lockPosition: true},
        {headerName: "Nombre", field: "nombre", width: 120, resizable: true, sortable: true, filter: true,  pinned: 'left', lockPosition: true},
        {headerName: "PTS", field: "pts", width: 90, sortable: true, lockPosition: true},
        {headerName: "FGM", field: "fgM", width: 90, sortable: true, lockPosition: true, editable: true, singleClickEdit:true},
        {headerName: "FGA", field: "fgA", width: 90, sortable: true, lockPosition: true, editable: true, singleClickEdit:true},
        {headerName: "FG%", field: "fgP", width: 90, sortable: true, lockPosition: true},
        {headerName: "3PM", field: "thrM", width: 90, sortable: true, lockPosition: true, editable: true, singleClickEdit:true},
        {headerName: "3PA", field: "thrA", width: 90, sortable: true, lockPosition: true, editable: true, singleClickEdit:true},
        {headerName: "3P%", field: "thrP", width: 90, sortable: true, lockPosition: true},
        {headerName: "FTM", field: "ftM", width: 90, sortable: true, lockPosition: true, editable: true, singleClickEdit:true},
        {headerName: "FTA", field: "ftA", width: 90, sortable: true, lockPosition: true, editable: true, singleClickEdit:true},
        {headerName: "FT%", field: "ftP", width: 90, sortable: true, lockPosition: true},
        {headerName: "OREB", field: "rOf", width: 90, sortable: true, lockPosition: true, editable: true, singleClickEdit:true},
        {headerName: "DREB", field: "rDf", width: 90, sortable: true, lockPosition: true, editable: true, singleClickEdit:true},
        {headerName: "REB", field: "rT", width: 90, sortable: true, lockPosition: true, editable: true, singleClickEdit:true},
        {headerName: "AST", field: "As", width: 90, sortable: true, lockPosition: true, editable: true, singleClickEdit:true},
        {headerName: "TOV", field: "TO", width: 90, sortable: true, lockPosition: true, editable: true, singleClickEdit:true},
        {headerName: "STL", field: "St", width: 90, sortable: true, lockPosition: true, editable: true, singleClickEdit:true},
        {headerName: "BLK", field: "Bl", width: 90, sortable: true, lockPosition: true, editable: true, singleClickEdit:true},
        {headerName: "PF", field: "Fo", width: 90, sortable: true, lockPosition: true, editable: true, singleClickEdit:true},
    ];
    ...
    setTimeout(function(){ new agGrid.Grid(eGridDiv, gridOptions); }, 400)
}
function saveChanges(){
    arrayQ1.forEach(function(jugador){
        console.log("twoM:",jugador.fgM-jugador.thrM );
